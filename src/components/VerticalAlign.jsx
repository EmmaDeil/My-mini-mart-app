    ...
    <div className="container text-center" id='vertical-align'>
      <div className="row" style={{ minHeight: '400px' }}>
        <div className="col align-self-start">
          <div className="p-3 bg-light border rounded" style={{ height: '10rem', justifyContent: 'center', alignItems: 'center', display: 'flex' }}>
            We embrace change and continuously seek new ways to improve our solutions.
          </div>
        </div>
        <div className="col align-self-center">
          <div className="p-3 bg-primary text-white border rounded" style={{ height: '10rem', justifyContent: 'center', alignItems: 'center', display: 'flex' }}>
           We conduct our business with honesty and transparency.
          </div>
        </div>
        <div className="col align-self-end">
          <div className="p-3 bg-success text-white border rounded" style={{ height: '10rem', justifyContent: 'center', alignItems: 'center', display: 'flex' }}>
      ...
      <div className="row" style={{ minHeight: '400px', marginTop: '2rem' }}>
        ...
        <div className="col align-self-center">
          <div className="p-3 bg-info text-white border rounded" style={{ height: '10rem', justifyContent: 'center', alignItems: 'center', display: 'flex' }}>
